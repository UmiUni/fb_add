...
def locateAll(needleImage, haystackImage, grayscale=False, limit=None):
    ...
    while y < haystackHeight:
        ...
        #for matchx in _kmp(needleImageFirstRow, haystackImageData[y * haystackWidth:(y+1) * haystackWidth]):
            #r,g,b = haystackImageData[y*haystackWidth + matchx]   #for win
            r,g,b,_ = haystackImageData[y*haystackWidth + matchx]   #for mac
            ...
            if foundMatch:
                ...
                numMatchesFound += 1
                #yield (matchx, y, needleWidth, needleHeight)   #for win
                yield (matchx/2, y/2, needleWidth, needleHeight)   #for mac
